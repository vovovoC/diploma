              ...
              <div className="post-text">
                ...
                <div className="post-about">
                  ...
                  <p className="post-about-text">
                    Clean, cozy, refrigerator, washing machine, cable TV, +
                    rent, for the long term, TV, all appliances. Hostel with an
                    ideal location for tourists, direct flights to Medeo,
                    Shymbulak, walking distance to the cable car to Koktyube,
                    Republic Square, in front of the hostel the Terrenekur River
                    with cycling track, park area, also hotels Kazakhstan,
                    Dostyk Ave. and Abay
                  </p>
                </div>
                <hr />
