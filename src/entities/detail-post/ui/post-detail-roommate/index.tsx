...
export const RoommatePostDetail = ({fn } : Props) => {
  return (
    <div className="user-anketa roommate-detail">
      ...
      <div className="right-anketa-header">
          <div className="anketa-header-title roomate-anketa-header-title">Hi, I’m Madina Alzhan</div>
        ...
        <p className="post-detail-roommate-title"><b>I'm looking for a room</b></p>
        <table>
          <tbody>
            <tr>
              <th>Target date</th>
      ...
      <div className="user-anketa-left">
          <button className="post-close" title="Close" onClick={() => fn()}><CloseIcon sx={{backgroundColor: "transparent"}}/></button>
          <div className="user-anketa-left-card">
            ...
            <div className="roommate-post-action">
                ...
                <IconButton
                  ...
                  sx={{ border: "1px solid #C7C7C7", p: "6px 5px 4px", width: "30px" }}
                >
