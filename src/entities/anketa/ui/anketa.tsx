            ...
            <table>
               <tbody>
                  ...
                  <tr className="delete-acc">
                    <th><Typography sx={{color: "#D50000", textDecoration: "underline",
                            backgroundColor: "transparent", p: "0", textTransform: "uppercase",  display: "block",fontSize: {xs: "10px",s: "10px", md: "14px"}}} onClick={handleToggle}>Delete account</Typography>
                        <Backdrop
                          sx={{ zIndex: (theme) => theme.zIndex.drawer + 1}}
                          open={open}
                          onClick={handleClose}
